...
class Spaceship_6(Unit):
    path_blue = 'resources/img/Spaceship_pack_pack_06_BLUE.png'
    path_red = 'resources/img/Spaceship_pack_pack_06_RED.png'
    path_blue_dead = 'resources/img/Spaceship_pack_pack_06_BLUE-dead.png'
    path_red_dead = 'resources/img/Spaceship_pack_pack_06_RED-dead.png'
    ...
    def __init__(self, uuid: UUID, game, start_pos,
                 hp: int = 250, atk_damage: int = 40, atk_speed: int = 300, atk_range: int = 150, speed: float = 0.27,
