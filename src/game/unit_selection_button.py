...
from src.game.unit_type import UnitType
...
class UnitSelectionButton():
    def __init__(self, x, y, image, scale, font, unit_type, price="10", is_visible=True, clicked=False):
        ...
        self.text: pygame.Surface = self.font.render(self.price, True, "Black")
    ...
    def update(self, screen: pygame.Surface):
        ...
        if self.is_visible:
            self.text = self.font.render(self.price, True, "Black")
